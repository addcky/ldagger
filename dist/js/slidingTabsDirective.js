    ...
    return {
        ...
        link: function(scope, element, attrs, parent) {
            ...
            var init = function () {
                ...
                var tabItems = '<li ng-repeat="(key, value) in tabs" ng-click="onTabTabbed($event, {{key}})" class="sidr slider-slide-tab" ng-bind-html="value"></li>';
                ...
                if(options.slideTabsScrollable) {
                    ...
                    tabsBar = angular.element('<div class="slidingTabs"><ul  class="sidrbox">' + tabItems + '</ul> <div class="tab-indicator-wrapper"><div class="tab-indicator"></div></div> </div>');
